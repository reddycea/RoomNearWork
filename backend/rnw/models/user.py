...
class User(UserMixin, TimestampMixin, db.Model):
    ...
    verification = db.relationship("LandlordVerification", foreign_keys="LandlordVerification.user_id", back_populates="user", uselist=False, cascade="all, delete-orphan")subscriptions = db.relationship("UserSubscription", back_populates="user", cascade="all, delete-orphan", order_by="UserSubscription.created_at.desc()")
